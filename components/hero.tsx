  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          variants={heroItem}
          className="mt-8 flex w-full max-w-[280px] flex-col items-center gap-2.5 sm:mt-10 sm:w-auto sm:max-w-none sm:flex-row sm:gap-3">
          <a
            href="#works"
            className="glass flex w-[220px] items-center justify-center rounded-lg px-12 py-[1.875rem] text-lg font-medium text-fg transition-colors duration-300 hover:border-white/25 hover:bg-white/6"
          >
            {content.hero.ctaPrimary}
          </a>
          <a
            href="#contact"
            className="group flex w-[220px] items-center justify-center gap-2.5 rounded-lg bg-fg px-12 py-[1.875rem] text-lg font-medium text-ink transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(255,255,255,0.12)]"
          >
